...
function applyDistortion($image, $imageWidth, $imageHeight)
{
    ...
    $backgroundColor = imagecolorallocate($distortedImage, 255, 255, 255);
...
{
    $variationColor = imagecolorallocate($image, 0, 0, 0); // Color for variations
...
{
    $lineColor = imagecolorallocate($image, 161, 161, 161); // Black
...
{
    $noiseLevel = 100; // Adjust noise level as needed
...
{
    $gridColor = imagecolorallocate($image, 141, 141, 141); // Black
